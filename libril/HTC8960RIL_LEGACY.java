 ...
 * {@hide}
 */
public class HTC8960RIL_LEGACY extends QualcommSharedRIL implements CommandsInterface {
    ...
    public HTC8960RIL_LEGACY(Context context, int networkMode, int cdmaSubscription) {
